...
class Galeri extends CI_Controller {
	...
	{
        $this->form_validation->set_rules('title', 'Judul foto', 'trim|htmlspecialchars|required',
            array(
                'required'      => '%s tidak boleh kosong'
            )
        );

        $this->form_validation->set_rules('description', 'Caption', 'trim|htmlspecialchars|required|max_length[200]',
            array(
                'required'      => '%s tidak boleh kosong',
