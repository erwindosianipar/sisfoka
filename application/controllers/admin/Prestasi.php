...
class Prestasi extends CI_Controller {
	...
	public function create()
	{
        ...
        $this->form_validation->set_rules('description', 'Deskripsi', 'trim|htmlspecialchars|required|min_length[10]',
            array(
                'required'      => '%s tidak boleh kosong',
                'min_length'    => '%s minimal panjang sepuluh huruf'
            )
        ...
        $this->form_validation->set_rules('content', 'Konten', 'trim|required|min_length[10]',
            array(
                'required'      => '%s tidak boleh kosong',
                'min_length'    => '%s minimal panjang sepuluh huruf'
            )
