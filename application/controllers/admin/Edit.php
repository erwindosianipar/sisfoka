...
class Edit extends CI_Controller {
	...
	{
        $this->form_validation->set_rules('description', 'Deskripsi', 'trim|htmlspecialchars|required',
            array(
	...
	public function sambutan_kepsek()
	{
        ...
        $this->form_validation->set_rules('name', 'Nama', 'trim|htmlspecialchars|required',
            array(
                'required'      => '%s tidak boleh kosong'
            )
        );
