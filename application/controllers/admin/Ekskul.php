...
class Ekskul extends CI_Controller {
	...
	{
        $this->form_validation->set_rules('name', 'Nama ekstrakurikuler', 'trim|htmlspecialchars|required',
            array(
        ...
        $this->form_validation->set_rules('lead', 'Nama pembimbing', 'trim|htmlspecialchars|required',
            array(
                'required'      => '%s tidak boleh kosong'
            )
        );
