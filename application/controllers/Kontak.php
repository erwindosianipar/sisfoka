...
class Kontak extends CI_Controller {
	...
	{
		$this->form_validation->set_rules('name', 'Nama', 'trim|htmlspecialchars|required|callback_alpha_space|min_length[3]',
			array(
		...
		$this->form_validation->set_rules('about', 'Subjek', 'trim|htmlspecialchars|required|min_length[3]',
			array(
				'required'  	=> '%s tidak boleh kosong',
				'min_length'	=> '%s minimal 3 karakter'
			)
		...
		$this->form_validation->set_rules('phone', 'Nomor telepon', 'trim|htmlspecialchars|required|min_length[6]|max_length[15]',
			array(
				'required'  	=> '%s tidak boleh kosong',
		...
		$this->form_validation->set_rules('message', 'Pesan', 'trim|htmlspecialchars|required|min_length[6]',
			array(
				'required'  	=> '%s tidak boleh kosong',
				'min_length'	=> '%s minimal 6 karakter'
			)
