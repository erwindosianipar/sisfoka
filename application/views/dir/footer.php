        ...
        <div class="row">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md d-none d-lg-block">
                        <h5 class="bold text-uppercase">SMK Pelita Pematangsiantar</h5>
                        <div>&copy; <?= date('Y'); ?> SMK Pelita Pematangsiantar. All Rights Reserved.</div>
                    </div>
                    <div class="col-6 col-md">
                        <h5 class="bold">Tentang</h5>
                        <ul class="list-unstyled">
                            <li><a class="text-footer" href="<?= base_url('page/sejarah'); ?>">Sejarah</a></li>
                            <li><a class="text-footer" href="<?= base_url('page/visi-misi'); ?>">Visi dan Misi</a></li>
                            <li><a class="text-footer" href="<?= base_url('page/logo-motto'); ?>">Logo dan Motto</a></li>
